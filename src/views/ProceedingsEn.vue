<template>
  <div class="proceedings-container">
    <div class="content-wrapper">
      ...
      <!-- Current Conference Papers/Reports/Posters List -->
      <section class="proceedings-section">
        <h2>📋 CJNLP 2025 Reports/Posters List</h2>

        <div class="category-tabs">
          <div class="tab" :class="tab===0?'active':''"  @click="changeTab(0)">All</div>
          <div class="tab" :class="tab===2?'active':''" @click="changeTab(2)">Reports</div>
          <div class="tab" :class="tab===3?'active':''" @click="changeTab(3)">Posters</div>
        </div>

        <div class="paper-search">
          <input type="text" v-model="keywords" placeholder="Search by title, author, or keywords..." class="search-input">
        ...
        <div class="papers-list">
            ...
            <template v-for="(i,index) in thesisList.lists">
              <div class="paper-item">
                ...
                <div class="paper-content">
                  ...
                  <p class="keywords"><span>Keywords：</span>{{ i.keywords }}</p>
          ...
          <template v-else>
            <div class="paper-item empty-state">
              <div class="paper-type type-report">Report</div>
              <div class="paper-content">
      ...
      <!-- Outstanding Papers -->
      <section class="proceedings-section">
        <h2>🏆 Outstanding Speaker</h2>
        <div class="best-papers">
          <div class="best-paper-item">
            <h3>CJNLP 2025 Outstanding Speaker</h3>
      ...
      <section class="proceedings-section">
        <h2>📚 Past Conference Proceedings</h2>
              ...
              <div class="proceedings-item">
                ...
                <div class="proceedings-info">
                  ...
                  <div class="action-buttons">
                    <a :href="'/en/proceedings-list?year=' + i.year" class="action-btn view-btn">
                      <span class="icon">🔍</span>
                      View Online
                    </a>
                  </div>
      ...
      <section class="proceedings-section">
        <h2>📝 Proceedings Inclusion and Submission</h2>
        <div class="submission-info">
          <p>The CJNLP 2025 proceedings will be published soon. If your submission has been accepted, please note the following:</p>
          <ul>
            <li>Final paper submission deadline: September 10, 2025</li>
            <li>Reports/posters must follow the conference template requirements</li>
          </ul>
        </div>
      </section>
    </div>
