  ...
  <div class="proceedings-container">
    <div class="content-wrapper">
      ...
      <section class="proceedings-section">
        <h2>📋 CJNLP 2025 報告/ポスターリスト</h2>

        <div class="category-tabs">
          <div class="tab" :class="tab===0?'active':''"  @click="changeTab(0)">すべて</div>
          <div class="tab" :class="tab===2?'active':''" @click="changeTab(2)">報告</div>
          <div class="tab" :class="tab===3?'active':''" @click="changeTab(3)">ポスター</div>
        </div>

        <div class="paper-search">
          <input type="text" v-model="keywords" placeholder="タイトル、著者、またはキーワードで検索..." class="search-input">
        ...
        <div class="papers-list">
            ...
            <template v-for="(i,index) in thesisList.lists">
              <div class="paper-item">
                ...
                <div class="paper-content">
                  ...
                  <p class="keywords"><span>キーワード：</span>{{ i.keywords }}</p>
          ...
          <template v-else>
            <div class="paper-item empty-state">
              <div class="paper-type type-report">報告</div>
              <div class="paper-content">
              ...
              <template v-if="excellentThesisList.lists && excellentThesisList.lists.length > 0">
                <template v-for="(i,index) in excellentThesisList.lists">
                  <div class="paper-card">
                    ...
                    <p class="authors">{{i.authors}}</p>
                    <p class="affiliation">{{i.abstract}}</p>
                    <a href="#" class="paper-link">論文を閲覧</a>
                  </div>
                </template>
              </template>
              <template v-else>
              ...
              <div class="proceedings-item">
                ...
                <div class="proceedings-info">
                  ...
                  <div class="action-buttons">
                    <a :href="'/ja/proceedings-list?year=' + i.year" class="action-btn view-btn">
                      <span class="icon">🔍</span>
                      オンライン閲覧
                    </a>
                  </div>
      ...
      <section class="proceedings-section">
        ...
        <div class="submission-info">
          <p>CJNLP 2025論文集がまもなく出版されます。投稿が採択された方は以下の点にご注意ください：</p>
          <ul>
            <li>最終版論文提出期限：2025年9月10日</li>
            <li>報告/ポスターは会議のテンプレート要件に従ってください</li>
          </ul>
        </div>
      </section>
    </div>
