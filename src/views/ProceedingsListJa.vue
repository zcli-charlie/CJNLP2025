    ...
    <div class="content-wrapper">
      ...
      <div class="filter-section">
        <div class="search-box">
          <input type="text" v-model="searchQuery" placeholder="タイトル、著者、キーワードで検索..." class="search-input">
          <button class="search-btn" @click="handleSearch">検索</button>
        </div>
        <div class="filter-tabs">
          <div class="tab" :class="{ active: currentType === 0 }" @click="handleTypeChange(0)">すべて</div>
          <div class="tab" :class="{ active: currentType === 1 }" @click="handleTypeChange(1)">論文</div>
          <div class="tab" :class="{ active: currentType === 2 }" @click="handleTypeChange(2)">報告</div>
          <div class="tab" :class="{ active: currentType === 3 }" @click="handleTypeChange(3)">ポスター</div>
        </div>
      </div>
      ...
      <div class="papers-list">
        <div v-for="paper in paperList" :key="paper.id" class="paper-item">
          ...
          <div class="paper-content">
            ...
            <p class="keywords"><span>キーワード：</span>{{ paper.keywords }}</p>
...
const fetchConferenceInfo = async () => {
  try {
    ...
    console.error('会議情報の取得に失敗しました:', error)
  }
}
...
const fetchPapers = async () => {
  try {
    ...
    console.error('論文リストの取得に失敗しました:', error)
  }
}
