      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="80px" inline>
        ...
        <el-form-item label="Password" prop="password">
          <el-input
            ...
            placeholder="Please enter password (optional)"
            type="password"
            show-password
          />
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="handleCheck">Query</el-button>
        </el-form-item>
      </el-form>
    </div>
          ...
          <div class="table-item-content">
              ...
              <div class="table-item-left">
                <div class="table-item-left-top">
                  ...
                  <div class="table-item-left-top-nationality">
                    {{ item.nationality === 0 ? "Chinese" : "Japanese" }}
                  </div>
                </div>
            ...
            <div class="table-item-content2">
              <div class="table-item-content2-i">
                <div class="table-item-content2-i-title">Registration</div>
              ...
              <div class="table-item-content2-i">
                <div class="table-item-content2-i-title">Payment</div>
                <div class="table-item-content2-i-content">
              ...
              <div class="table-item-content2-i">
                <div class="table-item-content2-i-title">Check-in</div>
                <div class="table-item-content2-i-content">
...
const handleSearch = () => {
  // Search logic implemented through computed
};
